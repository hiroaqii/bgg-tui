...
pub const Config = struct {
    ...
    pub fn validate(config: Config) ValidationError!void {
        ...
        if (!isOneOf(config.interface.transition, &.{ "none", "fade", "glitch", "code-rain", "dissolve", "sweep", "wipe", "warp", "scanline", "iris", "shutter", "lines", "lines-cross", "random" })) return error.InvalidTransition;
